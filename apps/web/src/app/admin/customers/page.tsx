...
export default function AdminCustomers() {
    const [customers] = useState([
        { id: "#CUST-101", name: "Berke Yılmaz", email: "berke@example.com", phone: "+90 532 123 4567", orders: 12, spent: "â‚º45.200", joined: "15 Ocak 2026", status: "Premium" },
        { id: "#CUST-102", name: "Aslı Çelik", email: "asli@example.com", phone: "+90 544 987 6543", orders: 3, spent: "â‚º8.900", joined: "2 Mart 2026", status: "Aktif" },
        ...
        { id: "#CUST-104", name: "Zeynep Demir", email: "zeynep@example.com", phone: "+90 533 444 5566", orders: 28, spent: "â‚º112.500", joined: "5 Kasım 2025", status: "VIP" },
    ]);
