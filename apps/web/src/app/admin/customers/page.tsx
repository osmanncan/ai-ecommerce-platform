...
export default function AdminCustomers() {
    const [customers] = useState([
        { id: "#CUST-101", name: "Berke YÄ±lmaz", email: "berke@example.com", phone: "+90 532 123 4567", orders: 12, spent: "â‚º45.200", joined: "15 Ocak 2026", status: "Premium" },
        { id: "#CUST-102", name: "AslÄ± Ã‡elik", email: "asli@example.com", phone: "+90 544 987 6543", orders: 3, spent: "â‚º8.900", joined: "2 Mart 2026", status: "Aktif" },
        { id: "#CUST-103", name: "Kaan Aras", email: "kaan@example.com", phone: "+90 555 111 2233", orders: 1, spent: "â‚º1.200", joined: "10 Mart 2026", status: "Yeni" },
        { id: "#CUST-104", name: "Zeynep Demir", email: "zeynep@example.com", phone: "+90 533 444 5566", orders: 28, spent: "â‚º112.500", joined: "5 KasÄ±m 2025", status: "VIP" },
    ]);
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-black tracking-tighter uppercase text-zinc-900 leading-none">MÃ¼ÅŸteriler</h1>
                    <p className="text-zinc-400 text-sm mt-2 font-medium">Sisteme kayÄ±tlÄ± {customers.length} mÃ¼ÅŸteri bulunuyor.</p>
                </div>
                <button className="px-6 py-3 bg-white border border-zinc-200 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-zinc-50 transition-colors">DÄ±ÅŸa Aktar (CSV)</button>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 bg-white p-4 rounded-2xl border border-zinc-200">
                <div className="flex-1 relative">
                    ...
                    <input
                        type="text"
                        placeholder="MÃ¼ÅŸteri adÄ±, telefon veya e-posta..."
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead className="bg-zinc-50 border-b border-zinc-200">
                            <tr>
                                <th className="text-left py-5 px-8 text-[10px] font-black uppercase tracking-widest text-zinc-400">MÃ¼ÅŸteri Profili</th>
                                <th className="text-left py-5 px-8 text-[10px] font-black uppercase tracking-widest text-zinc-400">Ä°letiÅŸim</th>
                                <th className="text-left py-5 px-8 text-[10px] font-black uppercase tracking-widest text-zinc-400">SipariÅŸ / Harcama</th>
                                <th className="text-left py-5 px-8 text-[10px] font-black uppercase tracking-widest text-zinc-400">KayÄ±t Tarihi</th>
                                ...
                                <tr key={customer.id} className="hover:bg-zinc-50/50 transition-colors group">
                                    ...
                                    <td className="py-5 px-8">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 mt-0.5">{customer.orders} SipariÅŸ</span>
                                        </div>
                                    </td>
                                    <td className="py-5 px-8">
