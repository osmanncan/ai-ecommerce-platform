...
export default function AdminDashboard() {
    const stats = [
        { label: "Toplam Satış", value: "₺142.950", icon: DollarSign, trend: "+12.5%", isPositive: true },
    ...
    const recentOrders = [
        { id: "#AURA-8F2D", customer: "Ahmet Yılmaz", date: "2 dakika önce", amount: "₺4.250", status: "Hazırlanıyor", color: "blue" },
        { id: "#AURA-9A1C", customer: "Ayşe Kaya", date: "15 dakika önce", amount: "₺1.890", status: "Ödendi", color: "green" },
        { id: "#AURA-7B4E", customer: "Mehmet Demir", date: "1 saat önce", amount: "₺12.400", status: "Kargolandı", color: "orange" },
        { id: "#AURA-2D9F", customer: "Zeynep Aras", date: "3 saat önce", amount: "₺850", status: "Tamamlandı", color: "emerald" },
    ];
                        ...
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="flex items-center gap-4 group cursor-pointer">
                                ...
                                <div className="text-right">
                                    <p className="text-sm font-black text-zinc-900">₺{450 * (5 - i)}</p>
