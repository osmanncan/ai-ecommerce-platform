        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-5xl">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-zinc-400 text-sm mt-2 font-medium">Mağaza tercihlerini ve sistem yapılandırmalarını yönetin.</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                ...
                <div className="lg:col-span-3 space-y-1 z-10 sticky top-28">
                    {[
                        ...
                        { title: "Çoklu Dil", icon: Globe },
                        { title: "Görünüm", icon: Smartphone },
                        { title: "Güvenlik", icon: Shield }
                    ].map((item, idx) => (
                ...
                <div className="lg:col-span-9 space-y-8">
                    ...
                    <div className="bg-white rounded-[32px] border border-zinc-200 p-10 shadow-sm relative overflow-hidden group">
                        ...
                        <h2 className="text-xl font-black uppercase tracking-tight text-zinc-900 mb-8 flex items-center gap-3">
                            <Store className="text-zinc-400" /> Genel Mağaza Ayarları
                        </h2>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-3">
                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500">Mağaza Adı</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500">Destek E-Postası</label>
                            ...
                            <div className="space-y-3 md:col-span-2">
                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500">Kısa Açıklama (SEO)</label>
                                <textarea defaultValue="Yeni Nesil Lüks E-Ticaret Platformu" rows={3} className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-5 py-3.5 text-sm font-bold text-zinc-900 focus:outline-none focus:ring-2 focus:ring-black/5 focus:bg-white transition-all resize-none" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-[32px] border border-zinc-200 p-10 shadow-sm">
                        <h2 className="text-xl font-black uppercase tracking-tight text-zinc-900 mb-8 flex items-center gap-3">
                            <CreditCard className="text-zinc-400" /> Ödeme Altyapısı
                        </h2>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between p-5 border border-zinc-200 rounded-2xl bg-zinc-50 hover:bg-white transition-colors cursor-pointer">
                                <div>
                                    ...
                                    <p className="text-xs text-zinc-500 mt-1 font-medium">Kredi kartı ile ödeme almak için aktif.</p>
                                </div>
                            ...
                            <div className="flex items-center justify-between p-5 border border-zinc-200 rounded-2xl bg-zinc-50 hover:bg-white transition-colors cursor-pointer opacity-50">
                                <div>
                                    ...
                                    <p className="text-xs text-zinc-500 mt-1 font-medium">Yurtdışı ödemeleri için kullanılabilir.</p>
                                </div>
