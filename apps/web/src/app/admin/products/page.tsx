...
export default function AdminProducts() {
    const [products, setProducts] = useState([
        { id: "PRD-001", name: "Premium Ä°pek GÃ¶mlek", category: "Ãœst Giyim", price: 2450, stock: 45, status: "Aktif", image: "https://images.unsplash.com/photo-1598554747436-c9293d6a588f?q=80&w=200&h=200&fit=crop" },
        { id: "PRD-002", name: "Minimalist Deri Ã‡anta", category: "Ã‡anta", price: 8900, stock: 12, status: "AzalÄ±yor", image: "https://images.unsplash.com/photo-1584916201218-f4242ceb4809?q=80&w=200&h=200&fit=crop" },
        { id: "PRD-003", name: "Oversize KaÅŸe Kaban", category: "DÄ±ÅŸ Giyim", price: 12500, stock: 0, status: "TÃ¼kendi", image: "https://images.unsplash.com/photo-1539533018447-63fcce2678e3?q=80&w=200&h=200&fit=crop" },
        { id: "PRD-004", name: "Klasik KumaÅŸ Pantolon", category: "Alt Giyim", price: 1850, stock: 156, status: "Aktif", image: "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?q=80&w=200&h=200&fit=crop" },
    ]);
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-black tracking-tighter uppercase text-zinc-900 leading-none">ÃœrÃ¼n YÃ¶netimi</h1>
                    <p className="text-zinc-400 text-sm mt-2 font-medium">Toplam {products.length} Ã¼rÃ¼n listeleniyor.</p>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 bg-white p-4 rounded-2xl border border-zinc-200">
                <div className="flex-1 relative">
                    ...
                    <input
                        type="text"
                        placeholder="ÃœrÃ¼n adÄ± veya ID ara..."
                ...
                <div className="flex gap-2">
                    <select className="bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-2.5 text-sm font-bold text-zinc-600 focus:outline-none focus:ring-2 focus:ring-black/5 appearance-none">
                        ...
                        <option>Ãœst Giyim</option>
                        <option>DÄ±ÅŸ Giyim</option>
                        <option>Ã‡anta</option>
                    </select>
            ...
            <div className="bg-white rounded-3xl border border-zinc-200 overflow-hidden shadow-sm">
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead className="bg-zinc-50 border-b border-zinc-200">
                            <tr>
                                <th className="text-left py-5 px-8 text-[10px] font-black uppercase tracking-widest text-zinc-400">ÃœrÃ¼n</th>
                                ...
                                <tr key={product.id} className="hover:bg-zinc-50/50 transition-colors group">
                                    ...
                                    <td className="py-4 px-8">
                                        <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest ${product.status === 'Aktif' ? 'bg-green-50 text-green-600' :
                                                product.status === 'AzalÄ±yor' ? 'bg-orange-50 text-orange-600' :
                                    ...
                                    <td className="py-4 px-8 text-right">
                                        <div className="flex justify-end items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button className="p-2 bg-zinc-100 hover:bg-zinc-200 text-zinc-600 rounded-lg transition-colors" title="DÃ¼zenle">
                                                <Edit size={16} />
                                            </button>
                ...
                <div className="p-4 border-t border-zinc-200 flex items-center justify-between text-xs font-bold text-zinc-500 bg-zinc-50/50">
                    <span>GÃ¶sterilen: 1-4 / Toplam: 42</span>
